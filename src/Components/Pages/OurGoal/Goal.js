    ...
    return (
        <section>
            <div className='text-center mt-8'>
                <h1 className="text-3xl lg:text-4xl font-medium">WHAT WE DO</h1>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mx-12 mt-6'>
                <div className="card w-72 lg:w-96">
